    ...
    <main style={{ minHeight: '100vh', background: '#10100f', color: '#f3f1eb', fontFamily: 'Arial, sans-serif' }}>
      <section style={{ maxWidth: 760, margin: '0 auto', padding: '90px 24px' }}>
        ...
        <div style={{ marginTop: 32, padding: 24, border: '1px solid #373632', borderRadius: 18, background: '#171715' }}>
          ...
          >
            {running ? <><Loader2 size={17} className="spin" style={{ verticalAlign: '-3px', marginRight: 7 }}/> Regenerating…</> : <><RefreshCw size={17} style={{ verticalAlign: '-3px', marginRight: 7 }}/> Regenerate all 245 previews <ArrowRight size={17} style={{ verticalAlign: '-3px', marginLeft: 7 }}/></>}
          </button>
