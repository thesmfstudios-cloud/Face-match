...
AI-style event photo delivery MVP for SMF Studio.

## Current MVP
- Customer selfie upload flow
- Face-match results gallery UI
- Watermarked/blurred previews
...
- Real face embeddings / similarity search
