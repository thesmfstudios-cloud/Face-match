...
// Slightly lighter blur keeps the preview recognizable while still removing
// fine detail that customers would otherwise get from the paid original.
...
const GLYPHS = {
  ...
  O: [[[0.2, 0], [0.8, 0], [1, 0.2], [1, 0.8], [0.8, 1], [0, 0.8], [0, 0.2], [0.2, 0]]]
};
